...
function GapCard({ gap, index, onGenerate }: { gap: any; index: number; onGenerate: (t: string) => void }) {
  ...
  return (
    <div style={{ padding: '18px', background: 'rgba(22,27,34,0.65)', border: '1px solid #21262D', borderRadius: '10px', marginBottom: '8px' }}>
...
export default function ResearchPage() {
  ...
  const selectStyle: React.CSSProperties = {
    padding: '8px 12px', background: 'rgba(22,27,34,0.65)', border: '1px solid #21262D',
  ...
  return (
    <>
      ...
      <div style={{ padding: '28px', minHeight: '100vh', fontFamily: 'Geist, sans-serif' }}>
        ...
        {/* Mode Tabs */}
        <div style={{ display: 'flex', gap: '6px', marginBottom: '20px', background: 'rgba(22,27,34,0.65)', border: '1px solid #21262D', borderRadius: '10px', padding: '5px', width: 'fit-content' }}>
          {MODES.map(m => (
        ...
        <div style={{ display: 'flex', gap: '10px', marginBottom: '28px' }}>
          <input
            ...
            style={{ flex: 1, padding: '11px 16px', background: 'rgba(22,27,34,0.65)', border: '1px solid #21262D', borderRadius: '10px', color: '#E8EDF8', fontSize: '14px', outline: 'none', fontFamily: 'inherit' }}
          />
                ...
                {results.stats && (
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '10px', marginBottom: '16px' }}>
                    {Object.entries(results.stats).map(([key, val]) => (
                      <div key={key} style={{ padding: '14px', background: 'rgba(22,27,34,0.65)', border: '1px solid #21262D', borderRadius: '10px', textAlign: 'center' }}>
              ...
              <>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '10px', marginBottom: '16px' }}>
                  {['High', 'Medium', 'Low'].map(p => {
                    ...
                    return (
                      <div key={p} style={{ padding: '12px', background: 'rgba(22,27,34,0.65)', border: '1px solid #21262D', borderRadius: '10px', textAlign: 'center' }}>
