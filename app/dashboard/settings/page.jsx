  ...
  return (
    <div
      ...
      style={{
        ...
        background: value ? '#7c6fff' : 'rgba(255,255,255,0.08)',
...
export default function SettingsPage() {
  ...
  const textInput = (section, key, placeholder = '', type = 'text') => (
    <input
      type={type}
      ...
      style={{
        ...
        borderRadius: '9px', padding: '9px 13px', color: '#f1f5f9',
        fontSize: '13px', fontFamily: 'Inter, sans-serif', outline: 'none',
        width: '220px', transition: 'border-color 0.15s, box-shadow 0.15s',
      }}
  ...
  const selectInput = (section, key, options) => (
    <select
      value={settings[section][key] ?? ''}
      onChange={e => update(section, key, e.target.value)}
      style={{
        ...
        borderRadius: '9px', padding: '9px 13px', color: '#f1f5f9',
        fontSize: '13px', fontFamily: 'Inter, sans-serif', outline: 'none', width: '220px', cursor: 'pointer',
      }}
    >
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .save-btn {
          padding: 10px 28px; background: #7c6fff; border: none; border-radius: 10px;
            ...
            <div className="glass fade-up">
              ...
              {tab === 'General' && (
                <>
                  ...
                  <Field label="Site Name" desc="The name of your website or brand.">
                    {textInput('general', 'site_name', 'My SEO Site')}
                  </Field>
                  <Field label="Site URL" desc="Your website's root URL.">
                    {textInput('general', 'site_url', 'https://yoursite.com')}
                  </Field>
