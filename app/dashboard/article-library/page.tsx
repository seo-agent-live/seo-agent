      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        .lib-root {
          ...
          font-family: 'Inter', sans-serif; padding: 32px 32px 64px;
          position: relative;
        }
        .lib-root::before {
        ...
        .filter-btn {
          padding: 8px 14px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.07);
        ...
        .article-row {
          display: grid; grid-template-columns: 32px 1fr 70px 100px 110px 80px;
          gap: 12px; align-items: center; padding: 12px 14px; border-radius: 9px;
        ...
        .del-btn {
          padding: 5px 10px; border-radius: 6px; border: 1px solid rgba(248,113,113,0.2);
          background: rgba(248,113,113,0.08); color: #f87171; font-size: 11px; font-weight: 600;
          cursor: pointer; font-family: 'Inter', sans-serif; transition: all 0.15s;
        }
        .del-btn:hover { background: rgba(248,113,113,0.18); }
        .del-btn:disabled { opacity: 0.4; cursor: not-allowed; }
        .status-select {
          background: transparent; border: none; font-size: 11px; font-weight: 700;
          cursor: pointer; font-family: 'Inter', sans-serif; outline: none; padding: 3px 8px;
          border-radius: 5px;
        }
        .bulk-del-btn {
          padding: 8px 14px; border-radius: 8px; border: 1px solid rgba(248,113,113,0.2);
        ...
        <div className="inner">
          ...
          <div style={{ marginBottom: '28px' }}>
            ...
            <p style={{ fontSize: '14px', color: '#475569' }}>
              All your generated articles in one place.
            </p>
          </div>
          ...
          <div className="glass" style={{ padding: '16px' }}>
            ...
            {loading ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                {[1,2,3,4,5].map(i => (
                  <div key={i} className="skeleton" style={{ height: '50px', borderRadius: '9px' }} />
                ))}
              </div>
            ) : filtered.length === 0 ? (
                  ...
                  return (
                    <div className="article-row fade-up" key={a.id}>
                      ...
                      <div style={{
                        ...
                        background: scoreBg(a.seo_score ?? 0),
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                      }}>
                        <span style={{ fontSize: '11px', fontWeight: 700, color: scoreColor(a.seo_score ?? 0) }}>
                          {a.seo_score ?? '—'}
                        </span>
                      </div>
                      ...
                      <div style={{ background: stStyle.bg, borderRadius: '6px' }}>
                        <select
                          ...
                          value={st}
                          style={{ color: stStyle.color, background: 'transparent' }}
