...
const s = {
  ...
  qaCard:    { background: 'rgba(22,27,34,0.75)', border: '1px solid #21262D', borderRadius: '12px', padding: '16px', display: 'flex', alignItems: 'center', gap: '12px', cursor: 'pointer', textDecoration: 'none', transition: 'border-color 0.2s' },
  ...
  statCard:  { background: 'rgba(22,27,34,0.75)', border: '1px solid #21262D', borderRadius: '12px', padding: '20px' },
  ...
  card:      { background: 'rgba(22,27,34,0.75)', border: '1px solid #21262D', borderRadius: '12px', padding: '20px' },
