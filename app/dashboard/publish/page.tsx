...
function ConnectionModal({ platform, onClose, onConnect }) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      <div style={{ background: 'rgba(22,27,34,0.65)', border: '1px solid #21262D', borderRadius: '16px', padding: '28px', width: '100%', maxWidth: '480px' }}>
...
function PublishModal({ article, platform, connection, onClose, onPublished }) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      <div style={{ background: 'rgba(22,27,34,0.65)', border: '1px solid #21262D', borderRadius: '16px', padding: '28px', width: '100%', maxWidth: '520px', maxHeight: '90vh', overflowY: 'auto' }}>
...
export default function PublishPage() {
  ...
  return (
    <>
      ...
      {/* Toast */}
      {notification && (
        <div style={{ position: 'fixed', bottom: '24px', right: '24px', zIndex: 2000, background: 'rgba(22,27,34,0.65)', border: '1px solid #21262D', borderRadius: '10px', padding: '12px 18px', fontSize: '13px', color: '#E8EDF8', boxShadow: '0 8px 32px rgba(0,0,0,0.4)' }}>
          ✓ {notification}
        </div>
      )}
            ...
            <div>
              {!selectedArticle ? (
                ...
                <>
                  ...
                  <div style={{ background: 'rgba(22,27,34,0.65)', border: '1px solid #21262D', borderRadius: '12px', padding: '20px', marginBottom: '20px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: '12px' }}>
                    {PLATFORMS.map(platform => {
                      ...
                      if (platform.id === 'copy') {
                        return (
                          <div key={platform.id} style={{ background: 'rgba(22,27,34,0.65)', border: '1px solid #21262D', borderRadius: '12px', padding: '20px' }}>
                      ...
                      return (
                        <div key={platform.id} style={{ background: 'rgba(22,27,34,0.65)', border: `1px solid ${isConnected ? 'rgba(29,184,160,0.2)' : '#21262D'}`, borderRadius: '12px', padding: '20px' }}>
